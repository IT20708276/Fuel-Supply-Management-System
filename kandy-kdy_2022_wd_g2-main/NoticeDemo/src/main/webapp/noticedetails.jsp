...
<link href="noticecss/noticedetailstyles.css" rel="stylesheet"/>
</head>
<body>
<!-- header menu bar -->
<div class="header">
...
%>
 ...
 <!-- Back Button -->
<a href="prioritypage.jsp"><button class="notice-back-button"><i class="fa fa-chevron-left" aria-hidden="true"></i></button></a>
