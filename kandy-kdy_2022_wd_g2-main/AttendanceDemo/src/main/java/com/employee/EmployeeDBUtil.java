...
public class EmployeeDBUtil {
	...
	public static List<Employee> validate(String month, String totalLeave){
		...
		try {
			...
			String sql = "select * from slip where month='"+month+"' and totalLeave='"+totalLeave+"'";
	...
	public static boolean insertemployee(String totalOT, String totalLeave, String month, String totalDaysWorked){
	...
	try {
		con = DBConnect.getConnection();
		stat = con.createStatement();
		String sql = "insert into slip (totalOT, totalLeave, month, totalDaysWorked) values ('"+totalOT+"','"+totalLeave+"','"+month+"','"+totalDaysWorked+"')";
	...
	public static boolean updateslip(String id, String totalOT, String totalLeave, String month, String totalDaysWorked) {
		...
		try {
			con = DBConnect.getConnection();
			stat = con.createStatement();
			String sql = "update slip set totalOT ='"+totalOT+"',totalLeave = '"+totalLeave+"',month = '"+month+"', totalDaysWorked = '"+totalDaysWorked+"'"
					+ "where id = '"+id+"'";
	...
	public static List<Employee> getEmployeeDetails(String Id){
		...
		try {
			...
			con = DBConnect.getConnection();
			stat = con.createStatement();
			String sql = "select * from slip where id = '"+convertedID+"'";
			rs = stat.executeQuery(sql);
	...
	try {
		...
		con = DBConnect.getConnection();
		stat = con.createStatement();
		String sql = "select * from slip where id = '"+convID+"'";
		rs = stat.executeQuery(sql);
	...
	public static boolean deleteSlip(String id) {
		...
		try {
			...
			con = DBConnect.getConnection();
			stat = con.createStatement();
			String sql = "delete from slip where id= '"+convId+"'";
