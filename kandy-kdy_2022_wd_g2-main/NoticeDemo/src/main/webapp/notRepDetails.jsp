...
<!-- CSS link -->
 <link href="noticecss/noticereportstyles.css" rel="stylesheet"/>
...
<!-- Back Button -->
<a href="search.jsp"><button class="not-rep-backbtn"><i class="fa fa-chevron-left" aria-hidden="true"></i></button></a>
